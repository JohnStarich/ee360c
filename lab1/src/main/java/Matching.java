...
public class Matching {
	 ...
	 *
	 * The primary index is the landlord.
	 * The Vector at that index is the collection of apartment numbers they own.
	 */
	 ...
	 *
	 * The primary index is the landlord.
	 * The secondary index is the tenant.
	 * The final value is the landlord's preference on that tenant.
	 */
	 ...
	 *
	 * The primary index is the tenant.
	 * The secondary index is the apartment.
	 * The final value is the tenant's preference on that apartment.
	 */
